...
PRODUCT_COPY_FILES   += ${SAGE_APP_BINARY_PATH}/sage_framework_dev.bin:system/bin/sage_framework_dev.bin
PRODUCT_COPY_FILES   += ${SAGE_APP_BINARY_PATH}/sage_ta_adobe_dev.bin:system/bin/sage_ta_adobe_dev.bin
PRODUCT_COPY_FILES   += ${SAGE_APP_BINARY_PATH}/sage_ta_antirollback_dev.bin:system/bin/sage_ta_antirollback_dev.bin
PRODUCT_COPY_FILES   += ${SAGE_APP_BINARY_PATH}/sage_ta_dtcpip_dev.bin:system/bin/sage_ta_dtcpip_dev.bin
PRODUCT_COPY_FILES   += ${SAGE_APP_BINARY_PATH}/sage_ta_edrm_dev.bin:system/bin/sage_ta_edrm_dev.bin
PRODUCT_COPY_FILES   += ${SAGE_APP_BINARY_PATH}/sage_ta_hdcp22_dev.bin:system/bin/sage_ta_hdcp22_dev.bin
PRODUCT_COPY_FILES   += ${SAGE_APP_BINARY_PATH}/sage_ta_netflix_dev.bin:system/bin/sage_ta_netflix_dev.bin
PRODUCT_COPY_FILES   += ${SAGE_APP_BINARY_PATH}/sage_ta_secure_video_dev.bin:system/bin/sage_ta_secure_video_dev.bin
PRODUCT_COPY_FILES   += ${SAGE_APP_BINARY_PATH}/sage_ta_utility_dev.bin:system/bin/sage_ta_utility_dev.bin
PRODUCT_COPY_FILES   += ${SAGE_APP_BINARY_PATH}/sage_ta_widevine_dev.bin:system/bin/sage_ta_widevine_dev.bin
ifeq ($(ANDROID_SUPPORTS_PLAYREADY),y)
PRODUCT_COPY_FILES   += ${SAGE_APP_BINARY_PATH}/sage_ta_playready_25_dev.bin:system/bin/sage_ta_playready_25_dev.bin
PRODUCT_COPY_FILES   += ${SAGE_APP_BINARY_PATH}/sage_ta_playready_30_dev.bin:system/bin/sage_ta_playready_30_dev.bin
endif
endif
endif
