...
SAGE_BL_BINARY_PATH  ?= ${BCM_VENDOR_STB_ROOT}/prebuilts/sage/${TARGET_SAGE_PLATFORM}/${LOCAL_DEVICE_SECURITY_VARIANT_DEV}
...
SAGE_BINARY_EXT2      ?=
SAGE_BL_BINARY_PATH2  ?= ${BCM_VENDOR_STB_ROOT}/prebuilts/sage/${TARGET_SAGE_PLATFORM}/${LOCAL_DEVICE_SECURITY_VARIANT_PROD}
...
PRODUCT_PROPERTY_OVERRIDES += \
   ro.vendor.nrdp.audio.mixer.buffersize=3848
