...
# additional properties defined per device go here.
PRODUCT_PROPERTY_OVERRIDES += ${LOCAL_PROPERTY_OVERRIDES}
...
PRODUCT_COPY_FILES   += ${SAGE_APP_BINARY_PATH}/sage_ta_common_drm.bin:system/bin/sage_ta_common_drm.bin
...
PRODUCT_COPY_FILES   += ${SAGE_APP_BINARY_PATH}/dev/sage_ta_common_drm_dev.bin:system/bin/sage_ta_common_drm_dev.bin
