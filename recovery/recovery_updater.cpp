...
void Register_librecovery_updater_ext() {

    fprintf(stderr, "installing updater extensions\n");

    RegisterFunction("ext.flash_bolt", FlashBoltExtFn);
    RegisterFunction("ext.flash_gpt", FlashGPTExtFn);
}
