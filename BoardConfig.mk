...
BOARD_CACHEIMAGE_FILE_SYSTEM_TYPE  := $(LOCAL_DEVICE_USERDATA_FS)
BOARD_SYSTEMIMAGE_PARTITION_SIZE   := $(LOCAL_DEVICE_SYSTEM_NAB)
BOARD_VENDORIMAGE_PARTITION_SIZE   := $(LOCAL_DEVICE_VENDOR_NAB)
else
...
BOARD_USERDATAIMAGE_FILE_SYSTEM_TYPE := $(LOCAL_DEVICE_USERDATA_FS)
