...
B_DHD_OBJ_ROOT_REL           := ${OUT_DIR}/target/product/${LOCAL_PRODUCT_OUT}/obj/FAKE/dhd
B_NIC_OBJ_ROOT               := ${BRCMSTB_ANDROID_OUT_PATH}/target/product/${LOCAL_PRODUCT_OUT}/obj/FAKE/nic
B_NIC_OBJ_ROOT_REL           := ${OUT_DIR}/target/product/${LOCAL_PRODUCT_OUT}/obj/FAKE/nic
...
ifeq ($(filter-out n,${BDSP_MS10_SUPPORT} ${BDSP_MS11_SUPPORT} ${BDSP_MS12_SUPPORT}),)
LOCAL_DOLBY_SUPPORT := $(shell \
	NEXUS_TOP=${NEXUS_TOP} \
	NEXUS_PLATFORM=${NEXUS_PLATFORM} \
	PLATFORM=${PLATFORM} \
	BCHP_CHIP=${BCHP_CHIP} \
	BCHP_VER=${BCHP_VER} \
	MAGNUM_TOP=${MAGNUM_TOP} \
	BDSP_DDP_SUPPORT=${BDSP_DDP_SUPPORT} \
	BDSP_MS10_SUPPORT=${BDSP_MS10_SUPPORT} \
	BDSP_MS11_SUPPORT=${BDSP_MS11_SUPPORT} \
	BDSP_MS12_SUPPORT=${BDSP_MS12_SUPPORT} \
	ENV_TO_PRINT=BDSP_AC3_SUPPORT \
	make -f ${ANDROID}/device/broadcom/common/middleware/printenv.mk)
else
LOCAL_DOLBY_SUPPORT := y
endif
export LOCAL_DOLBY_SUPPORT
