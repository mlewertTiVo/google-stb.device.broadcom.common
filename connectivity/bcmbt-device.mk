...
PRODUCT_COPY_FILES += \
    ${BCM_VENDOR_STB_ROOT}/bcm_platform/conx/btusb/firmware/BCM43242A1_001.002.007.0077.0000_Generic_USB_Class2_Generic_3DTV_TBFC_37_4MHz_Wake_on_BLE_Hisense.hcd:system/vendor/broadcom/btusb/firmware/BCM_bt_fw.hcd
endif

ifeq ($(BROADCOM_WIFI_CHIPSET),43570a0)
PRODUCT_COPY_FILES += \
    ${BCM_VENDOR_STB_ROOT}/bcm_platform/conx/btusb/firmware/BCM43569A0_001.001.009.0039.0000_Generic_USB_40MHz_fcbga_BU_TXPwr_8dbm_4.hcd:system/vendor/broadcom/btusb/firmware/BCM_bt_fw.hcd
endif
...
PRODUCT_COPY_FILES += ${BCM_VENDOR_STB_ROOT}/bcm_platform/conx/btuart/firmware/BCM20703A1_001.001.005.0357.0720_UART_20MHz_WakeOnBle_Google.hcd:system/vendor/broadcom/btuart/firmware/BCM_bt_fw.hcd
